...
public class PositionForCoralL1 extends SequentialCommandGroup {
  /** Creates a new PositionForCoralL1. */
  public PositionForCoralL1(Tilter objTilter, Elevator objElevator, GroundIntake objGroundIntake, GroundPivot objGroundPivot, CoralIntake objCoralIntake) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new RunCombinedTiltElev(objTilter, objElevator, Constants.MechPos.dTiltHome, Constants.MechPos.dElevHome),
      new RunGroundPivot(objGroundPivot, null, false, Constants.MechPos.dGroundPosL1)
    );
  }
}
