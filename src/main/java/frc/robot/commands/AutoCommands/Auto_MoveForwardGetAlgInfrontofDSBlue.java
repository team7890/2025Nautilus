...
public class Auto_MoveForwardGetAlgInfrontofDSBlue extends SequentialCommandGroup {
  /** Creates a new Auto_MoveForwardGetAlgInfrontofDS. */
  public Auto_MoveForwardGetAlgInfrontofDSBlue(CommandSwerveDrivetrain objDriveTrain, Tilter objTilter, Elevator objElevator, AlgaeIntake objAlgaeIntake, CoralIntake objCoralIntake, double dMaxSpeed, double dMaxAngularRate) {
   //
    addCommands(
