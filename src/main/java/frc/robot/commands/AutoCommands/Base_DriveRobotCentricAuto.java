...
public class Base_DriveRobotCentricAuto extends Command {
  ...
  public Base_DriveRobotCentricAuto(CommandSwerveDrivetrain objSwerve_in, double dMaxSpeed_in, double dMaxAngularRate_in, double dTranslateY_in, double dTranslateX_in, double dRotate_in) {
