...
public class Auto_MoveForwardAndGetAlgwithouthomeRed extends SequentialCommandGroup {


  /** Creates a new Auto_MoveForward. */
  public Auto_MoveForwardAndGetAlgwithouthomeRed(CommandSwerveDrivetrain objDriveTrain, Tilter objTilter, Elevator objElevator, AlgaeIntake objAlgaeIntake, CoralIntake objCoralIntake, GroundPivot objGroundPivot, GroundIntake objGroundIntake, double dMaxSpeed, double dMaxAngularRate) {
