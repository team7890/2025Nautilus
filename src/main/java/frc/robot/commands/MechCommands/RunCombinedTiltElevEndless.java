...
public class RunCombinedTiltElevEndless extends Command {
  ...
  /** Creates a new RunCombinedTiltElevEndless. */
  public RunCombinedTiltElevEndless(Tilter objTilter_in, Elevator objElevator_in, double dTargetTilt_in, double dTargetElev_in) {
