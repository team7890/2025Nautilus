...
public class RunAlgTilterWithIntakeL2 extends SequentialCommandGroup {
  /** Creates a new RunAlgTilterWithIntake. */
  public RunAlgTilterWithIntakeL2(Tilter objTilter, Elevator objElevator, AlgaeIntake objAlgaeIntake)
